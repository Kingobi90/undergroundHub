      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-lg font-bold mb-2">Campus Hub</h3>
          ...
          <div className="mb-4 md:mb-0">
            ...
            <div className="flex flex-col text-sm">
              <a href="#" className="hover:text-accent-hover mb-1">Campus Map</a>
              <a href="#" className="hover:text-accent-hover mb-1">Events</a>
              <a href="#" className="hover:text-accent-hover mb-1">News</a>
              <a href="#" className="hover:text-accent-hover">Confessions</a>
            </div>
          </div>
